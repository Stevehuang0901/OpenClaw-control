...
export function OfficeStoryPanel({
  ...
  return (
    <section className="panel p-5">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-3 max-w-3xl text-sm leading-relaxed text-ink/66">
            The office floor is already doing the heavy lifting. This strip only
            tells you what is happening now, what comes next, and whether release
            work is waiting on approval.
          </p>
        </div>
      ...
      <div className="mt-5 rounded-none border-2 border-ink/12 bg-[#14101c] p-4 shadow-pixel">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <p className="pixel-label">Workflow rhythm</p>
