          ...
          >
            <div className="flex flex-wrap items-start justify-between gap-3">
              ...
              <div className="text-right text-xs uppercase tracking-[0.18em] text-ink/60">
                ...
                <div className="mt-2">
                  {workflow.usage
                    ? `${formatNumber(workflow.usage.totalTokens)} tok est`
                    : "--"}
                </div>
              </div>
            </div>
            ...
            <div className="mt-4 flex flex-wrap items-center gap-2">
              {workflow.tasks.map((task, index) => (
                <Fragment key={task.id}>
                  <div className="min-w-[160px] rounded-none border-2 border-ink/15 bg-white/70 p-3">
            ...
            {workflow.id === selectedWorkflowId ? (
              <div className="mt-4 grid gap-4 xl:grid-cols-[0.9fr_1.1fr]">
                <div className="rounded-none border-2 border-ink/15 bg-white/60 p-4">
                  ...
                  <div className="mt-3 space-y-3">
                    {workflow.tasks.map((task) => {
                      ...
                      return (
                        <div
                          key={`${task.id}-trace`}
                          className="rounded-none border-2 border-ink/10 bg-paper/70 p-3"
                        >
                ...
                <div className="rounded-none border-2 border-teal bg-teal/10 p-4 text-sm leading-relaxed text-ink">
